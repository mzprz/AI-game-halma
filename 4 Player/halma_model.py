...
ASAL_10_13_1=[(0,9),(0,8),(1,9),(0,7),(1,8),(2,9),(0,6),(1,7),(2,8),(3,9),(1,6),(2,7),(3,8)]
ASAL_10_13_2=[(9,9),(9,8),(8,9),(9,7),(8,8),(7,9),(9,6),(8,7),(7,8),(6,9),(8,6),(7,7),(6,8)]
ASAL_10_13_3=[(9,0),(9,1),(8,0),(9,2),(8,1),(7,0),(9,3),(8,2),(7,1),(6,0),(8,3),(7,2),(6,1)]
...
class HalmaModel:
    ...
    # mengembalikan jumlah bidak per pemain
    ...
    # mengembalikan array posisi semua bidak pemain tertentu
    ...
    def mainMulai(self):
        ip = self.__giliran
        self.__waktu[ip] += self.JATAH_WAKTU
